...
// Cria tabelas do SagaOrchestrator de forma idempotente — EnsureCreated pula a criação
// se o banco já contém tabelas de outros serviços (inventory, etc.), por isso usamos
